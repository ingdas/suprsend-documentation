...
description: "This document guides you to integrate apns push notifications in native iOS application."
---
...
<Steps>
  ...
  <Step title="Asking User to send push notifications">
    ...
    1. [Provisional Authorization](/docs/ios-push-integration-2#2-provisional-authorization-supported-in-ios-120-and-above)
    ...
    <Accordion title="Provisional Authorization (Supported in iOS 12.0 and above)" defaultOpen={false}>
      [Provisional notifications](/docs/ios-push-integration-2#2-provisional-authorization-supported-in-ios-120-and-above) are sent quietly to the users —they don’t interrupt the user with a sound or banner. Also, they will not be shown when your app is in foreground.&#x20;



      First time this type of notifications are sent, user is asked to "Keep" or "Turn off" the notifications. If they click on "Keep", the further notifications continue to be sent
  ...
  <Step title="Adding support for Notification service.">
    ...
    1. After clicking on "Finish", a folder will be created with your given product name. Inside that there will be **NotificationService.swift** file like below.

    ![](/images/docs/507d91a-Screenshot_2022-09-27_at_8.30.25_PM.png)

    1. In your project podFile add following snippet to add support for notification service to access SuprSend SDK methods. In below snippet replace with name you given to notification service while creating it.
    ...
    ![](/images/docs/d33de71c2e154a8622ee0ebf51e1d8747715b5496215b73db289fe6010c525be-Screenshot_2024-09-03_at_2.08.29_PM.png)

    1. Replace the content in **NotificationService.swift** file with below code to start sending push notifications with image

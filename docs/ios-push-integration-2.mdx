...
[Suggest Edits](/edit/ios-push-integration-2)
...
2. [Provisional Authorization](/docs/ios-push-integration-2#2-provisional-authorization-supported-in-ios-120-and-above)
...
5. In your project podFile add following snippet to add support for notification service to access SuprSend SDK methods. In below snippet replace with name you given to notification service while creating it.

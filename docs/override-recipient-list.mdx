...
description: "Learn what override recipient setting in trigger node"
---
...
To handle such cases, you can override the default recipient with another identifier specified in the event property. For example, if this is the event call, you can pass `.recipient` in the recipient field to send the notification to `joe@example.com`

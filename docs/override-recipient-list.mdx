...
[Suggest Edits](/edit/override-recipient-list)
...
3. In the below array object example, if you want to send notifications to all the admins of an organization, enter the format `.organization.admins[].user_id`.

---
title: "AWS SNS"
description: "https://aws.amazon.com/sns/"
---

[Suggest Edits](/edit/aws-sns-sms)
...
To send email through SNS, you need an IAM user (Access-Key-ID and Secret-Access-Key) with necessary permission. To ceate an IAM user, refer to this [documentation](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html)
...
2. Add relevant configuration and expand Delivery status logging.
3. Create a new IAM role on this screen. It will ask for permission to send delivery logs to cloudwatch, allow that and save changes.
...
* * [Pre-Requisites](#pre-requisites)
  ...
  * [Amazon SNS integration on SuprSend account](#amazon-sns-integration-on-suprsend-account)

    * [Step 1. Create AWS IAM user](#step-1-create-aws-iam-user)
    * [Step 2. Adding phone number in your SNS account](#step-2-adding-phone-number-in-your-sns-account)
    * [Step 3. Add SNS Vendor settings on Suprsend dashboard](#step-3-add-sns-vendor-settings-on-suprsend-dashboard)

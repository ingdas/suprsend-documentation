...
[Suggest Edits](/edit/design-workflow)
...
We are adding more functions to support the complex notification usecases. Have a use case in mind? Reach out to us in our [Slack community](https://suprsendcommunity.slack.com/join/shared_invite/zt-1bs6rbxr8-zI6SyJQd2b~XMpM9uaT1Bw#/shared-invite/email), and we'll prioritize it.
...
* [Delay](/docs/delay)
* [Batch](/docs/batch)
* [Delivery - Single Channel](/docs/delivery-single-channel)
* [Delivery - Multi-Channel](/docs/delivery-multi-channel)
* [Smart Channel Routing](/docs/smart-delivery)
* [Wait Until](/docs/wait-until)
...
* * [Prerequisites](#prerequisites)
  ...
  * [Designing workflow](#designing-workflow)

    * [1. Trigger Node](#1-trigger-node)
    * [2. Function Nodes](#2-function-nodes)
    * [3. Branch Nodes](#3-branch-nodes)
    * [4. Delivery Nodes](#4-delivery-nodes)
    * [Workflow Settings](#workflow-settings)
    * [Change Node name and Description](#change-node-name-and-description)

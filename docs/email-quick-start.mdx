...
[Suggest Edits](/edit/email-quick-start)
...
### 2. Start testing in Sandbox workspace
...
* **Template** in delivery node contains the content of the notification. You can add both static and dynamic content sourced from user properties or trigger payloads. We use handlebars as our email templating language. You can add dynamic content as `{{var}}`. Add trigger data in the **mock** to get variable auto-suggestions during editing.\
  Ensure to publish the template before using it in a workflow. [Learn more about how to design email template here](/docs/email).
...
### 5. Check logs to see the status of your sent notification
...
* Go through our [best practices](/docs/best-practices) around system usage and API setup.
...
* Here are some blogs that may come in handy to improve your email deliverability and engagement:

  * [The Ultimate Guide to Improving Email Deliverability for Product Teams in 2024](https://www.suprsend.com/post/the-ultimate-guide-to-improving-email-deliverability-for-product-teams-in-2023)
  * [A Developer's Guide to SPF, DKIM, and DMARC to Authenticate Their Emails](https://www.suprsend.com/post/authenticating-your-emails-a-developers-guide-to-spf-dkim-and-dmarc)
  * [How to Identify Email Spam Rate with Google Postmaster in the Next 60 Seconds?](https://www.suprsend.com/post/how-to-identify-email-spam-rate-with-google-postmaster-in-the-next-60-seconds)
  * [5 Actionable Tips To Reduce Email Spam Rates In 1 Week (Without Changing Domains)](https://www.suprsend.com/post/5-actionable-tips-to-reduce-email-spam-rates-in-1-week-without-changing-domains)

* If you are tracking your users and events in a third party data platform like [Segment](/docs/segment), you can setup email notifications with SuprSend in a no-code manner without having to integrate any SuprSend SDK.
...
* * [1. Create SuprSend account](#1-create-suprsend-account)
  * [2. Start testing in Sandbox workspace](#2-start-testing-in-sandbox-workspace)
  ...
  * [5. Check logs to see the status of your sent notification](#5-check-logs-to-see-the-status-of-your-sent-notification)
  * [6. Test with your Email vendor](#6-test-with-your-email-vendor)

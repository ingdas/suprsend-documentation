...
In above code replace **`your_distinct_id`**, **`your_subscriber_id`** and **`your_workspace_key`** variables with valid values.

Find the [Example Code](https://github.com/suprsend/suprsend-web-inbox/blob/main/index.html).

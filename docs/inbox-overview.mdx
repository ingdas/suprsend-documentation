...
<CardGroup cols={4}>
  <Card title="React" icon="react" href="/docs/inbox-react">
    (Web)
  </Card>

  <Card title="Angular" icon="angular" href="/docs/inbox-angular">
    (Web)
  </Card>

  <Card title="React Native " icon="react" href="/docs/inbox-react-native">
    (App)
  </Card>

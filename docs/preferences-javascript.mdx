...
* [Integrate Javascript SDK](/docs/integrate-java-sdk)

* [Identify user on login](/docs/java-create-user) and [reset on logout](/docs/java-create-user) to ensure that preference changes are tagged to the correct user
...
* [data](/docs/preferences-javascript#data-property) - The data set you'll need to populate the categories and channels on user's preference page

### Methods

* [get\_preferences](/docs/preferences-javascript#get_preferences) - get full user preferences data from the SuprSend

* [update\_category\_preference](/docs/preferences-javascript#update_category_preference) - method to update overall category preference when user opts out and opts in the category using category level switch.

![](/images/docs/3fb9ea2-update_category.png)

* [update\_channel\_preference\_in\_category](/docs/preferences-javascript#update_channel_preference_in_category) - method to update channel preference inside a category when user opts out and opts in a channel inside the category.

![](/images/docs/f6806e6-channel-category-update.png)

* [update\_overall\_channel\_preference](/docs/preferences-javascript#update_overall_channel_preference) - method to update overall channel preference for instance if user wants to receive only important notifications on SMS.

![](/images/docs/9491874-channel-update.png)

### Event Listeners

* [preferences\_updated](/docs/preferences-javascript#preferences_updated) - You'll get this event as soon as preference changes are updated. Response will return return the updated preference data object which you can use to update your UI.

* [preferences\_error](/docs/preferences-javascript#preferences_error) - This error event is fired when there are errors in API requests or implementation.

### Enums

* [PreferenceOptions](/docs/preferences-javascript#preferenceoptions) - Enum to read and update **category preference** and **channel preference in category**

* [ChannelLevelPreferenceOptions](/docs/preferences-javascript#channellevelpreferenceoptions) - Enum to read and update overall **channel preference**
...
1. [Overall Channel-level preference](/docs/preferences-javascript#4-overall-channel-preferences) - You can fetch this data from ChannelPreference section

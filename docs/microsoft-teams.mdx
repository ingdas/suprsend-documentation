...
1. [Update user or channel profile](/docs/microsoft-teams#step-3-update-teams-channel-in-user-profile) to send message

2. [Create Microsoft Teams template ](/docs/ms-teams-template)and trigger workflowx

<Steps>
  <Step title=" Create Teams App">
    ...
    <Steps>
      <Step title="Creat a MS365 Account">
      ...
      <Step title="Now select App feature from your left panel to click on Bot." />

      <Step title="If you have an existing bot, select it from the list or click on &#x22;Create a new bot&#x22;">
        <Accordion title="Creating a New Bot" defaultOpen={false}>
  ...
  <Step title="Add Teams integration on SuprSend">
  ...
  <Step title="Update teams channel in user profile">
    ...
    <AccordionGroup>
      ...
      <Accordion title="Order of Precedence" defaultOpen={false}>
  ...
  <Step title="Create Teams template">

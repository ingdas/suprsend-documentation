...
[Suggest Edits](/edit/react-native-create-user)
...
Once the user info is set, you can send events from your SDK by passing user `distinct_id` and trigger notification from the SuprSend platform

* [Send and Track Events](/docs/react-native-send-event-data)

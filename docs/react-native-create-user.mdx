...
<Steps>
  <Step title="Create/Identify a new user">
    You can identify a user using `suprsend.identify()` method. Call this method as soon as you know the identity of user, that is after login authentication. If you don't call this method, user will be identified using distinct\_id (uuid) that sdk generates internally.
  ...
  <Step title="Set Communication Channels">

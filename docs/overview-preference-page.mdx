...
<Card title="Javascript (Web)" href="/docs/preferences-javascript">
...
<Card title="Angular" href="/docs/angular">
  Insert content here
</Card>
...
<Steps>
  <Step title="Add preference page link in brand settings page">

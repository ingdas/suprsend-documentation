...
On the SuprSend dashboard, go to vendor page from side panel, select iOSpush and fill in below details. You'll get all these informations from [Apple developer account](https://developer.apple.com/account/)

...
2. **What happens when I have multiple batch nodes in a workflow?**
...
3. **Do you support per-user batch windows?**
...
* * [How batching works](#how-batching-works)
  ...
  * [Batch Window](#batch-window)
    ...
    * [Fixed batch window](#fixed-batch-window)
    * [Dynamic batch window](#dynamic-batch-window)

  * [Batch Key](#batch-key)

  * [Retain Batch Events](#retain-batch-events)

  * [Using Batch variables in templates](#using-batch-variables-in-templates)

  * [Transforming Batch Variable Output](#transforming-batch-variable-output)

...
You can add a Fixed Batch Window or Dynamic Batch Window in your workflow. Dynamic batch window is computed using data in your event properties and can vary per user.

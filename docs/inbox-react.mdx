---
title: "React"
description: "React SDK to integrate Inbox, Toast notification functionality for React websites"
---
...
<Steps>
  <Step title="Stage-1 ">
    Bell icon count and toast message as soon as the notification is delivered

    ![](/images/docs/259b66b-image.png)
  </Step>

  <Step title="Stage-2">
    Inbox view after clicking on the bell icon

    ![](/images/docs/9bdbeae-image.png)

    You can also customize your inbox based on simple [customization options](/docs/react-customize-inbox) available in our SDK
  </Step>
</Steps>

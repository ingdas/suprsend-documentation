...
[Suggest Edits](/edit/delivery-multi-channel)
...
4. User preference is `opt-in` for the given channel and notification category (defined in workflow settings). You can check user preference status using [get user preference API](/reference/get-user-preferences-single-category).
...
* * [How the delivery node is executed?](#how-the-delivery-node-is-executed)
  * [Selecting channels for multi-channel delivery](#selecting-channels-for-multi-channel-delivery)

...
[Suggest Edits](/edit/whatsapp-cloud-api)
...
* Alternatively, you can go to the [https://developers.facebook.com/](https://developers.facebook.com/) and click Get Started.

After completing the verification and accepting terms, you should be able to access facebook developers dashboard: [https://developers.facebook.com/apps/?show\_reminder=true](https://developers.facebook.com/apps/?show_reminder=true).

## Setting up Whatsapp business account on Meta

### Step 1: Create/add your business app on meta developers console

On developer’s console ([https://developers.facebook.com/apps](https://developers.facebook.com/apps) ) create an app by clicking on **"Create app"** button, then select **"Other"** on the next screen of "What do you want your app to do?"
...
2. **Assigning assets to the new user**
...
2. Now, we'll have to assign the system user to our whatsapp account
...
| **Phone number ID**              | *mandatory* | Phone number ID linked to your your whatsapp business number. You can get this from [App dashboard](https://developers.facebook.com/apps) (Whatsapp -> API Setup). [Refer above step](/docs/whatsapp-cloud-api#step-4-add-a-valid-business-phone-number) for more details.                                                                        |
...
| **Whatsapp Business Account ID** | *mandatory* | WABA ID linked to your your whatsapp business number. This will be needs to automate the template approval process for your account. You can get this from [App dashboard](https://developers.facebook.com/apps) (Whatsapp -> API Setup). [Refer above step](/docs/whatsapp-cloud-api#step-4-add-a-valid-business-phone-number) for more details. |
| **App ID**                       | *mandatory* | App ID linked to your your whatsapp business account. This is used to auto approve your whatsapp templates. You can get this from [App dashboard](https://developers.facebook.com/apps). Refer step 7 for more details.                                                                                                                           |
...
* * [Pre-Requisites](#pre-requisites)
  ...
  * [Setting up Whatsapp business account on Meta](#setting-up-whatsapp-business-account-on-meta)

    * [Step 1: Create/add your business app on meta developers console](#step-1-createadd-your-business-app-on-meta-developers-console)
    * [Step 2: Setup Whatsapp Cloud API](#step-2-setup-whatsapp-cloud-api)
    * [Step 3: Send a test message](#step-3-send-a-test-message)
    * [Step 4: Add a valid business phone number](#step-4-add-a-valid-business-phone-number)
    * [Step 5: Generate access token](#step-5-generate-access-token)
    * [Step 6: Change App Mode to Live](#step-6-change-app-mode-to-live)
    * [Step 7: Get App ID](#step-7-get-app-id)

  * [Migrating existing Phone number to Whatsapp Cloud API](#migrating-existing-phone-number-to-whatsapp-cloud-api)

  * [Adding Whatsapp cloud configuration on SuprSend App](#adding-whatsapp-cloud-configuration-on-suprsend-app)

  * [Setting Callback URL for tracking DLR response](#setting-callback-url-for-tracking-dlr-response)

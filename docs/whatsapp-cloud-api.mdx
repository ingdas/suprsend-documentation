  ...
  <Step title="Generate access token" icon={5} stepNumber="5">
    ...
    <Steps>
      ...
      <Step title="Assigning assets to the new user">
        ...
        * To do this from whatsapp settings page go to whatsapp accounts -> select your account. Now on the right panel there will be an option to

          **Assign People**

          , from there assign the System User that we created above to your account. After it's assigned you'll be able to see in

...
### Benefits of Mansging Users in SuprSend
...
<CardGroup cols="4">
  <Card title="Python SDK" icon="python" href="/docs/python-create-user-profile">
    
  </Card>
  <Card title="Node SDK" icon="JS" href="/docs/node-create-user-profile">
    
  </Card>
  <Card title="Java SDK" icon="Java" href="/docs/java-create-user-profile">
    
  </Card>
  <Card title="Go SDK" icon="golang" href="/docs/go-create-user-profile">
...
<CardGroup cols="4">
  <Card title="Javascript SDK" icon="JS" href="/docs/java-create-user">
    1. (for web applications)
  </Card>
  <Card title="Android SDK" icon="Android" href="/docs/android-create-user">
    1. (for mobile applications)
  </Card>
  <Card title="React Native SDK" icon="mobile-button" href="/docs/react-native-create-user">
    1. (for mobile )
  </Card>
  <Card title="Flutter SDK" icon="Flutter" href="/docs/flutter-create-user">
    1. (for mobile applications)
  </Card>
</CardGroup>

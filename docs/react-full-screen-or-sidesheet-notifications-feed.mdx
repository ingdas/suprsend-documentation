...
description: "This will guide you through integration steps of feed in full screen or sidesheet in your react application"
---
...
**Note:** Please refer [Customising CSS styles](https://docs.suprsend.com/docs/customising-feed#customising-css-styles) section to view typedefs for `INotificationFeedTheme`.

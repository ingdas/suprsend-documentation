...
* * [Data structure of logs](#data-structure-of-logs)

    * [Notification Status](#notification-status)
    * [Notification Statuses tracked per channel](#notification-statuses-tracked-per-channel)
    * [Getting Logs and Notification status back to your database](#getting-logs-and-notification-status-back-to-your-database)

  * [Trouble debugging? Reach out to Support](#trouble-debugging-reach-out-to-support)

...
[Suggest Edits](/edit/node-create-user-profile)
...
* [Send and Track Events](/docs/node-send-event-data)
...
* * [Create user](#create-user)
  ...
  * [Communication channel methods](#communication-channel-methods)

    * [Add User Channels](#add-user-channels)
    * [Remove User Channels](#remove-user-channels)
    * [Remove User Channels in bulk](#remove-user-channels-in-bulk)

  * [Bulk API for updating multiple user profiles](#bulk-api-for-updating-multiple-user-profiles)

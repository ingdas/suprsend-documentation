...
You can load user preferences for a tenant by simply passing `tenant_id` in [Rest APIs](/reference/update-user-preference) and [preference centre SDK](/docs/embedded-preference-centre). Hosted preference page automatically loads preferences corresponding to the tenant passed in workflow trigger.

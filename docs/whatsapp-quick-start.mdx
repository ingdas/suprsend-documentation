...
<Steps>
  ...
  <Step title="Create a workflow" icon={3} stepNumber="3">
    ...
    2. **Delivery node** - Delivery nodes represent the channels where users will receive notifications. You can use
       ...
       [multi-channel](/docs/delivery-multi-channel) nodes, to send messages across multiple channels, though it’s generally better to use

       [smart channel routing](/docs/smart-delivery), to notify users sequentially rather than bombarding them on all channels at once.

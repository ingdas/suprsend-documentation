...
[Suggest Edits](/edit/objects-node-sdk)

## Pre-requisites

[Integrate Node SDK](/docs/integrate-node-sdk)
...
* * [Pre-requisites](#pre-requisites)
  ...
  * [Understanding Objects in Suprsend](#understanding-objects-in-suprsend)

  * [Upsert (create/update) an object](#upsert-createupdate-an-object)
  ...
  * [Edit Operations via Helper Methods](#edit-operations-via-helper-methods)

    * [1. Add Channels](#1-add-channels)
    * [2. Remove Channels](#2-remove-channels)
    * [3. Remove Channels in bulk](#3-remove-channels-in-bulk)

  * [Add Preferences in Object Profile](#add-preferences-in-object-profile)

    * [Set Preferred language](#set-preferred-language)
    * [Set Timezone](#set-timezone)

  * [Advanced Configuration - Set Object Properties](#advanced-configuration---set-object-properties)

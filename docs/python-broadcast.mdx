---
title: "Broadcast"
description: "Method to trigger broadcast on lists using python SDK"
---
...
<CodeGroup>
  ...
  "channels": [], # Pass channel values - email, sms, whatsapp, androidpush, iospush, ms_teams, slack, webpush
  "delay": "_time_delay_", 
  ...
  "template": "_template_slug_",
  "notification_category": "promotional",
  "channels": ["iospush"], # Pass channel values - email, sms, whatsapp, androidpush, iospush, ms_teams, slack, webpush
  # "delay": 30,
  # "trigger_at": "2022-12-27T11:14:51.643Z",
  "data": {
    "amount": "$100",

...
<CodeGroup>
  ...
  event = Event(distinct_id=distinct_id, event_name=event_name, properties=properties, idempotency_key="__uniq_request_id__", tenant_id="default")
...
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ----------- |
| `distinct_id`     | `distinct_id` of user performing the event. In case the event is system generated, pass a system user.                                              | string     | *mandatory* |
| `event_name`      | string identifier for the event like `new_comment`                                                                                                  | string     | *mandatory* |
...
| `tenant_id`       | unique identifier of the [tenant](/docs/brands)                                                                                                     | string     | *optional*  |
...
<Warning>
  **Event naming guidelines:**
  ...
  Event Name or Property Name should not start with **`$`** or **`ss_`**, as we have reserved these symbols for our internal events and property names.
</Warning>

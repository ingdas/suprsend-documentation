  ...
  <Step title="Using variables in the templates">
    ...
    <Steps>
      ...
      <Step title="Refer to an array element">
        To refer to an array element, enter in format `{{var1.[*index*].var2}}. Eg. to refer to `product\_name`of the first element of the array`array, enter `` {{array.[0].product_name}}` ``
      </Step>

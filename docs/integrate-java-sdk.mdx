...
[Suggest Edits](/edit/integrate-java-sdk)
...
* * [Installation](#installation)
    ...
    * [Option 1. As a Maven dependency for maven projects from downloaded jar](#option-1-as-a-maven-dependency-for-maven-projects-from-downloaded-jar)
    * [Option 2. As a jar file for non maven projects](#option-2-as-a-jar-file-for-non-maven-projects)

  * [Initialization](#initialization)

  * [Constructor to test SDK in debug mode](#constructor-to-test-sdk-in-debug-mode)

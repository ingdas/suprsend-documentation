...
Replace  and  with your workspace values. You will get both the tokens from your [Suprsend dashboard](https://app.suprsend.com/) ( section). For more details, check the [documentation on 'Workspaces'](/docs/workspace).

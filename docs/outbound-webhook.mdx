...
[Suggest Edits](/edit/outbound-webhook)
...
2. Once you have enabled webhook, you'll see a screen like below. Click on "Add Endpoint"

![](/images/docs/bef5d3d-webhook2.png)

3. This will open endpoint settings form. Add the endpoint URL that you have created in the first step and give it a description for your reference. Select the event type that you want to receive on this endpoint for each channel.

![](/images/docs/d048043-image.png)

4. Here's how an example configuration of enabling status updates for email notification looks like:
...
* * [How it works?](#how-it-works)
  ...
  * [Getting Started](#getting-started)
    ...
    * [1. Create an endpoint in your application to receive webhook requests](#1-create-an-endpoint-in-your-application-to-receive-webhook-requests)
    * [2. Add the endpoint in SuprSend dashboard and start receiving events](#2-add-the-endpoint-in-suprsend-dashboard-and-start-receiving-events)
    * [Webhook Payload Structure](#webhook-payload-structure)
    * [Webhook Payload Structure for 2 way communication](#webhook-payload-structure-for-2-way-communication)

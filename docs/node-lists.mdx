...
Send broadcast notification to users in list

* [Broadcast](/docs/node-broadcast)
...
* * [Create list](#create-list)
  ...
  * [Add subscribers to list](#add-subscribers-to-list)

  * [Remove subscribers from list](#remove-subscribers-from-list)

  * [Delete list](#delete-list)

  * [Replace users from the list](#replace-users-from-the-list)

    * [1. Start Sync to create draft version of the list](#1-start-sync-to-create-draft-version-of-the-list)
    * [2. Add Subscribers to draft list](#2-add-subscribers-to-draft-list)
    * [3. Remove Subscribers from draft list](#3-remove-subscribers-from-draft-list)
    * [4. Finish Sync to make the draft version live](#4-finish-sync-to-make-the-draft-version-live)
    * [Delete Draft list](#delete-draft-list)

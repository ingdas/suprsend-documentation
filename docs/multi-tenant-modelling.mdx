...
```mermaid
graph LR
    subgraph Unified["WorkVibe's Unified Notification System"]
        direction TB
        Spacer[ ]
        Templates[Templates]
        Workflows[Workflows]
    ...
    subgraph Admin["Customer Admin (Uber)"]
        WorkVibe[WorkVibe<br/>Template Variant<br/>Preference Settings]
    end
    
    subgraph EmpA["Employee A"]
        direction LR
        PrefsA[Preferences]
        AlertA[Alert]
    end
    
    subgraph EmpB["Employee B"]
        direction LR
        PrefsB[Preferences]
        AlertB[Alert]
    end
    ...
    WorkVibe -.->|Variant Template| PrefsA
    PrefsA --> AlertA
    
    WorkVibe -.->|Variant Template| PrefsB
    PrefsB --> AlertB
    
    style Unified fill:#e0f2fe,stroke:#0284c7,stroke-width:4px,color:#0c4a6e
    style Admin fill:#fff7ed,stroke:#ea580c,stroke-width:4px,color:#7c2d12
    style EmpA fill:#f0fdf4,stroke:#16a34a,stroke-width:4px,color:#14532d
    style EmpB fill:#f0fdf4,stroke:#16a34a,stroke-width:4px,color:#14532d
    style Trigger fill:#fef3c7,stroke:#f59e0b,stroke-width:3px,color:#78350f
    style Spacer fill:transparent,stroke:transparent,stroke-width:0px
    style Templates fill:#bfdbfe,stroke:#2563eb,stroke-width:2.5px,color:#1e3a8a
    style Workflows fill:#bfdbfe,stroke:#2563eb,stroke-width:2.5px,color:#1e3a8a
    style Preferences fill:#bfdbfe,stroke:#2563eb,stroke-width:2.5px,color:#1e3a8a
    style Vendors fill:#bfdbfe,stroke:#2563eb,stroke-width:2.5px,color:#1e3a8a
    style SuprSend fill:#e9d5ff,stroke:#9333ea,stroke-width:2.5px,color:#581c87
    style WorkVibe fill:#fce7f3,stroke:#ec4899,stroke-width:2.5px,color:#831843
    style PrefsA fill:#dcfce7,stroke:#22c55e,stroke-width:2.5px,color:#14532d
    style PrefsB fill:#dcfce7,stroke:#22c55e,stroke-width:2.5px,color:#14532d
    style AlertA fill:#fef3c7,stroke:#eab308,stroke-width:2.5px,color:#78350f
    style AlertB fill:#fef3c7,stroke:#eab308,stroke-width:2.5px,color:#78350f
```
...
WorkVibe implements an admin-only *Notification Settings* page within its application. This interface integrates with [SuprSend's Tenant Preference APIs](/reference/update-tenant-default-preference), authenticated via JWT scoped to the specific tenant, to fetch and update notification category configurations.

...
graph LR
    ...
    Trigger[Trigger] -.->|Input| Templates
    ...
    Templates -.->|Config| Admin
    Vendors -.->|Config| Admin
    
    Preferences -.->|Settings| PrefsA
    Preferences -.->|Settings| PrefsB
    
    WorkVibe -.->|Variant Template| PrefsA
    PrefsA -->|Deliver| AlertA
    
    WorkVibe -.->|Variant Template| PrefsB
    PrefsB -->|Deliver| AlertB
    
    style Unified fill:#e8f4f8,stroke:#2c5aa0,stroke-width:3px
    style Admin fill:#fff4e6,stroke:#d97706,stroke-width:3px
    style EmpA fill:#f0fdf4,stroke:#16a34a,stroke-width:3px
    style EmpB fill:#f0fdf4,stroke:#16a34a,stroke-width:3px
    style Trigger fill:#fef3c7,stroke:#f59e0b,stroke-width:2px
    style Spacer fill:transparent,stroke:transparent,stroke-width:0px,height:20px
    style Templates fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    style Workflows fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    style Preferences fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    style Vendors fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    style SuprSend fill:#ddd6fe,stroke:#8b5cf6,stroke-width:2px
    style WorkVibe fill:#fce7f3,stroke:#ec4899,stroke-width:2px
    style PrefsA fill:#dcfce7,stroke:#22c55e,stroke-width:2px
    style PrefsB fill:#dcfce7,stroke:#22c55e,stroke-width:2px
    style AlertA fill:#fef3c7,stroke:#eab308,stroke-width:2px
    style AlertB fill:#fef3c7,stroke:#eab308,stroke-width:2px
```

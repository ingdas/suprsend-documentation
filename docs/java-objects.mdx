...
<Accordion title="Add Channels Helper Method" >
...
<Accordion title="Remove Channels Helper Method" >
...
<Accordion title="Remove Channels in bulk Helper Method" >
...
<Accordion title="Set Preferred language" icon="language" iconType="solid">
  <CodeGroup>
...
<Accordion title="Set Preferred Timezone" icon="earth-americas" iconType="solid">
  <CodeGroup>

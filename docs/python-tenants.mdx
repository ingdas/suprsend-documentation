...
| Field                                          | Description                                                                                                                                                                |
| ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tenant_id (mandatory)                          | Unique identifier for the tenant (max 64 characters, case insenstive). It can contain characters \[a-z0-9\_\\-\] i.e. alphanumeric characters, \\\_(underscore) and -(hyphen). |

...
description: "Trigger another workflow as a step in running workflow."
---

[Suggest Edits](/edit/invoke-workflow)
...
![](/images/docs/1af5aac87cb2a2a032a22e212e9f21584b093fccda7b81f0df985d1657e87b5d-image.png)
...
| Data Type      | Referring this property in JSONNET          | Description                                                                                                                                                                                                                          |
| -------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| Brand / Tenant | pass as`data["$tenant"].<property_key>`     | Brand / Tenant properties corresponding to the tenant\_id passed in workflow trigger.                                                                                                                                                |
...
* * [Constructing Workflow Payload](#constructing-workflow-payload)

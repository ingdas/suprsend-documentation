...
* * [How branch works?](#how-branch-works)
  ...
  * [Constructing a condition](#constructing-a-condition)

    * [Data type](#data-type)
    * [Key-Value Pair](#key-value-pair)

  * [Adding Multiple Conditions in a single branch](#adding-multiple-conditions-in-a-single-branch)

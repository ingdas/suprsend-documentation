...
<CardGroup cols="2">
  <Card title="NPM Link" icon="link" href="https://www.npmjs.com/package/@suprsend/web-sdk" />

  <Card title="GitHub Link" icon="github" href="https://github.com/suprsend/suprsend-web-sdk" />
</CardGroup>

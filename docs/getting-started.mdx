...
At SuprSend, all the constituent components are decoupled from each other, making it modular in nature. The components can come from any source. All these components are configured as nodes in Workflows, where the processing happens for delivery and optimisation. This allows Workflows to handle any complexity possible in your communication usecases.
...
You can try out SuprSend APIs from our [Potsman collection](https://www.postman.com/suprsend/workspace/suprsend/collection/27786422-d77a13c1-8f59-406d-9669-078a10d52521)
...
- [Setting up your SuprSend account](/docs/getting-started-1)

- [Table of Contents](#)

- - [Introduction to Workflows](#introduction-to-workflows)
  - [How do you trigger notifications?](#how-do-you-trigger-notifications)
  - [SuprSend APIs](#suprsend-apis)

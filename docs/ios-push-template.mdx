...
1. Make sure you have entered the variable name and the sample value in the **Mock data** button.
...
* [iOS Push Integration](/docs/ios-push-integration)

* [Table of Contents](#)

* * [Design Template](#design-template)

  * [iOS Push Notification Fields Description](#ios-push-notification-fields-description)

  * [Adding Dynamic Content in iOS Push](#adding-dynamic-content-in-ios-push)

...
<Steps>
  <Step title="Login to your Segment account. ">
    1. Login to your Segment account. Select 
       ...
       **Destinations**
        ...
        from the side navigation menu and click on 
  ...
  <Step title="Add below mapping in the send request:">
    <Steps>
      <Step title="Select any of event type - track and identify">
        ![](https://mintlify.s3-us-west-1.amazonaws.com/suprsend/images/docs/71ff24e-image.png)
      </Step>

      <Step title="In Add test event, select Load Test Event from Source">
        ![](/images/docs/141834f-image.png)
      </Step>

      <Step title="In Select Mappings, add below details:">
        1. [`https://hub.suprsend.com/connector/segment/`](https://hub.suprsend.com/connector/segment/)
        ...
        3. `Bearer _api_key_`
           ...
           `Authorization`
            ...
            in headers. Please make sure to replace "

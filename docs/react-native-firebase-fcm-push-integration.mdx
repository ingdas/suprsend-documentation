...
<Steps>
  ...
  <Step title="Step 2">
    Add POST\_NOTIFICATIONS permission in AndroidManifest.xml if not present already.From your code call the SDK method to show a notification permission popup.&#x20;

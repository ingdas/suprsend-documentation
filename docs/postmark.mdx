...
1. On **Add webhook**, settings page, add [https://hub.suprsend.com/webhook/postmark/](https://hub.suprsend.com/webhook/postmark/) in webhook URL section and enable all events on Postmark.

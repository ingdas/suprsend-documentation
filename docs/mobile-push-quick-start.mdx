---
title: "Mobile Push"
description: "This is a quick setup guide to start sending Mobile Push notifications with SuprSend."
---

[Suggest Edits](/edit/mobile-push-quick-start)
...
### 2. Integrate push channel in your application
...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Native Android | 1. [Integrate Android SDK](/docs/integrate-android-sdk) 2. [Integrate FCM](/docs/android-firebase-fcm-push-integration) in native application                              | -                                                                                                                                        |
| React Native   | 1. [Integrate React Native SDK](/docs/integrate-react-native-sdk-android) 2. [Integrate FCM](/docs/react-native-firebase-fcm-push-integration) in react native application | [https://github.com/suprsend/suprsend-rn-sdk/tree/main/example](https://github.com/suprsend/suprsend-rn-sdk/tree/main/example)           |
| Flutter        | 1. [Integrate Flutter SDK](/docs/integrate-flutter-sdk-android) 2. [Integrate FCM](/docs/flutter-firebase-fcm-push-integration) in flutter application                     | [https://github.com/suprsend/suprsend-flutter-sdk/tree/main/example](https://github.com/suprsend/suprsend-flutter-sdk/tree/main/example) |

For iOS Applications, Integrate SuprSend SDK and APNS (service provider for sending iOS push notifications)

| Language     | Documentation                                                                                                                                       | Example App / Code                                                                                                                       |
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Native iOS   | 1. [Integrate iOS SDK](/docs/integrate-ios-sdk) 2. [Integrate APNS](/docs/ios-push-integration-2) in native application                             | -                                                                                                                                        |
| React Native | 1. [Integrate React Native SDK](/docs/integrate-react-native-sdk-ios) 2. [Integrate APNS](/docs/react-native-apns-push) in react native application | [https://github.com/suprsend/suprsend-rn-sdk/tree/main/example](https://github.com/suprsend/suprsend-rn-sdk/tree/main/example)           |
| Flutter      | 1. [Integrate Flutter SDK](/docs/integrate-flutter-sdk-ios) 2. [Integrate APNS](/docs/flutter-apns-push) in flutter application                     | [https://github.com/suprsend/suprsend-flutter-sdk/tree/main/example](https://github.com/suprsend/suprsend-flutter-sdk/tree/main/example) |
...
<CodeGroup>
  ...
  ssApi.identify(__distinct_id__)
  ...
  SuprSend.shared.identify(identity: __distinct_id__)
...
* **Template** in delivery node contains the content of the notification. You can add both static and dynamic content sourced from user properties or trigger payloads. We use handlebars as our Push templating language. You can add dynamic content as `{{var}}`. Add trigger data in the **mock** to get variable auto-suggestions during editing.\
  Ensure to publish the template before using it in a workflow. Learn how to design [Android push](/docs/push-notification) and [iOS push](/docs/ios-push-template) template here.
...
* * [1. Create SuprSend account](#1-create-suprsend-account)
  * [2. Integrate push channel in your application](#2-integrate-push-channel-in-your-application)
  ...
  * [4. Identify user to attach push token to their profile](#4-identify-user-to-attach-push-token-to-their-profile)
    * [Call reset to clear user data on log out](#call-reset-to-clear-user-data-on-log-out)

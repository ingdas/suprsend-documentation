...
[Suggest Edits](/edit/list-sync-via-database)
...
<Frame caption="Creating a new task from  tab">
  <img src="/images/docs/4b3ca82-Screenshot_2024-03-21_at_4.27.08_PM.png" />

  **"Sync tasks"**
</Frame>

<Frame caption="Updating users directly from the list page. List source should be  here">
  <img src="/images/docs/c0bcc0b-image.png" />
...
<Frame caption="always add a distinct_id column and use {{last_sync_time}} variable in your query">
  <img src="/images/docs/53b6274-image.png" />
</Frame>
...
We strongly recommend that you index a column in your database representing the date-time each row was last-updated. When you write your query, you should add a WHERE clause comparing your “last updated” column to the \{\{last\_sync\_time}}.
...
* * [Pre-requisites](#pre-requisites)
  ...
  * [Setting up list update](#setting-up-list-update)

    * [Step 1: Create a sync task](#step-1-create-a-sync-task)
    * [Step 2: Write SQL query to extract and load data](#step-2-write-sql-query-to-extract-and-load-data)
    * [Optimizing your query with Last sync time](#optimizing-your-query-with-last-sync-time)
    * [Step 3: Save query and commit to setup sync frequency](#step-3-save-query-and-commit-to-setup-sync-frequency)

  * [Enable / Disable sync](#enable--disable-sync)

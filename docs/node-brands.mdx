...
* * [Tenant datastructure:](#tenant-datastructure)

  * [Tenant methods](#tenant-methods)

    * [Upsert tenant](#upsert-tenant)
    * [Get tenant details](#get-tenant-details)
    * [Get tenants list](#get-tenants-list)

  * [Add tenant in Workflow](#add-tenant-in-workflow)

  * [Add tenant in Event](#add-tenant-in-event)

...
There's an [example code](https://github.com/suprsend/angular-example) to add our pre-defined UI at the end of this documentation. This is how a typical preference page will look like
...
* [Identify user on login](/docs/java-create-user#how-suprsend-identifies-a-user) and [reset on logout](/docs/java-create-user#step-2--call-reset-to-clear-user-data-on-log-out) to ensure that preference changes are tagged to the correct user
...
1. [Category Preference](/docs/angular) - User can set preferences at overall category level or select specific channels in a category from this section.

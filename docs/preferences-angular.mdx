...
- [Integrate Javascript SDK](https://docs.suprsend.com/docs/javascript-sdk)
- [Identify user on login](https://docs.suprsend.com/docs/javascript-sdk#2-authenticate-user) and [reset on logout](https://docs.suprsend.com/docs/javascript-sdk#3-reset-user) to ensure that preference changes are tagged to the correct user

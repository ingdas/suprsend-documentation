...
You can design template with a simple form editor tool. You can add variables with `Handlebars` language. You can check how the message will look in the preview section on the right side. Once designed, you can save the push notification template by clicking on Save Draft. When you are ready, you can Publish Draft by providing a name to the version. This will become the Live version, and will be used whenever the associated workflow is triggered.

![](/images/docs/7c43e80-Screenshot_2021-10-19_at_12.14.20_PM.png "Screenshot 2021-10-19 at 12.14.20 PM.png")
...
* [Android](/docs/mobile-app-sdk)

* [Table of Contents](#)

* * [Design Template](#design-template)

  * [Android Push Notification Fields Description](#android-push-notification-fields-description)

  * [Android Push - Advanced Configurations (*Optional*)](#android-push---advanced-configurations-optional)

  * [How to change the small icon for a notification?](#how-to-change-the-small-icon-for-a-notification)

    * [Option A. Adding a vector drawable](#option-a-adding-a-vector-drawable)
    * [Option B. Adding a png icon for small icon](#option-b-adding-a-png-icon-for-small-icon)

  * [How to add a custom sound file in your android project?](#how-to-add-a-custom-sound-file-in-your-android-project)

  * [Adding Dynamic Content in Android Push](#adding-dynamic-content-in-android-push)

...
<Steps>
  ...
  <Step title="From your code call the SDK method to show a notification permission popup">
    This method is asynchronous and returns permission values. To show permission popup we use flutter package ***permission\_handler***

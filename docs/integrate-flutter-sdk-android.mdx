...
Example: If you create a new Application class called [MainApplication.kt](https://github.com/suprsend/suprsend-flutter-sdk/blob/main/example/android/app/src/main/kotlin/com/suprsend/suprsend_flutter_sdk_example/SuprsendFlutterPluginTestApplication.kt) in your source package, go to your AndroidManifest file and enter the path of the class in the tag like this:
...
To call suprsend events, you'll need to import suprsend SDK in your dart file Go back to the flutter folder and follow below steps:

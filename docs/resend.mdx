...
2. Select the relevant [notification category](/docs/notification-category) from the list
...
* * [Resend integration on SuprSend account](#resend-integration-on-suprsend-account)
  * [Get API Key from Resend account](#get-api-key-from-resend-account)
  * [Whitelist email domain on Resend](#whitelist-email-domain-on-resend)
  * [Configuring Open/Click tracking for emails on Resend](#configuring-openclick-tracking-for-emails-on-resend)

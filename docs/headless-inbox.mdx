...
Enclose your notifications component in **`SuprSend Provider`**. SuprSend hooks can only be used in children of SuprSendProvider component.
...
| tenantId     | string (Optional)    | If you use multi-tenant architecture you can get inbox notifications for that specific tenant only.                                    |
...
| stores       | IStore\[] (Optional) | Pass stores array if you want to use [multi-tab feature](/docs/multi-tabs).                                                                  |

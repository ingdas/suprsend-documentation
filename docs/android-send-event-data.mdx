...
[Suggest Edits](/edit/android-send-event-data)

In this section, we'll cover how to send events to the Suprsend platform for both iOS and Android application

## Pre-requisites

1. [Integrate Android SDK](/docs/integrate-android-sdk)
2. [Create User Profile](/docs/android-create-user)
3. [Create Template on SuprSend platform](/docs/templates) - if you want to trigger workflow by passing the event
4. [Create Workflow on SuprSend Platform](/docs/workflows) - if you want to trigger workflow by passing the event

## Create Workflow on SuprSend Platform

For Event based workflow trigger, you'll have to [create the workflow on SuprSend Platform](/docs/workflows).

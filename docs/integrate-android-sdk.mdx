...
<Steps>
  <Step title="Initialising Suprsend Android SDK">
    ...
    Replace **`WORKSPACE KEY`** and **`WORKSPACE SECRET`** with your workspace values. You will get both the tokens from [Suprsend dashboard](https://app.suprsend.com/) (***Settings page -> "`API keys`"*** section).

...
4. Identify the user by passing `distinct_id` and `subscriber_id`. Refer [HMAC authentication](/v1.3/docs/inbox-hmac-authentication) section to understand how to generate subscriber\_id
...
* * [Installation](#installation)
  ...
  * [Integrating Inbox](#integrating-inbox)

  * [Integrating Toast](#integrating-toast)
  ...
  * [Design custom notification card component](#design-custom-notification-card-component)

  * [Set a custom click handler](#set-a-custom-click-handler)

  * [Customizing Toast](#customizing-toast)
    * [Styling toast theme](#styling-toast-theme)

  * [Customizing Empty Inbox screen](#customizing-empty-inbox-screen)
    * [Changing Empty screen content](#changing-empty-screen-content)

  * [Customizing styles using HTML template file](#customizing-styles-using-html-template-file)

...
You can programatically create / update tenant tenant using either one of our backend SDKs ([Python](/docs/tenants-python), [Node](/docs/node-tenants), [Java](/docs/tenants-java), [Go](/docs/tenants-api-go)) or through SuprSend dashboard. We'll cover the method to create tenant using SuprSend dashboard.
...
You can use [HTTP API](/reference/tenant-overview) or manage tenants using one of our backend SDKs:

1. [Update tenant using python SDK](/docs/tenants-python)

2. [Update tenant using node SDK](/docs/node-tenants)

3. [Update tenant using java SDK](/docs/tenants-java)

4. [Update tenant using go SDK](/docs/tenants-api-go)

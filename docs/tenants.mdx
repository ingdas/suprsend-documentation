...
* **Custom Template Designs for Each Tenant**- You can create unique template designs for each tenant using tenant-specific properties. Refer to the [above section](/docs/brands#using-brand-components-in-templates) for details on how to implement this.

...
<CardGroup cols="3">
  <Card title="Email" icon="envelope-dot" iconType="solid" href="/docs/email">
...
<CardGroup cols="3">
  <Card title="Android Push" icon="android" iconType="solid" href="/docs/push-notification">
    
  </Card>
  <Card title="iOSpush" icon="apple" iconType="solid" href="/docs/ios-push-template">
    
  </Card>
  <Card title="Web Push" icon="mobile-screen" iconType="solid" href="/docs/web-push">
...
<CardGroup cols="3">
  ...
  <Card title="WhatsApp" icon="Whatsapp" iconType="solid" href="/docs/whatsapp">

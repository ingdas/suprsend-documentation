...
[Suggest Edits](/edit/java-send-event-data)
...
If you handle communications to end users on behalf of your customers and want to send custom notifications for each brand, you can do that with the help of [brands](/docs/brands).

Just pass the **brand\_id** of your customer brand as **5th parameter in your event instance** like shown below and the properties of that brand will be used to replace brand variables in your template.
...
* * [Pre-requisites](#pre-requisites)
  ...
  * [Trigger events for custom brand](#trigger-events-for-custom-brand)
  * [Idempotent Requests](#idempotent-requests)
  * [Add file attachment in event (for email)](#add-file-attachment-in-event-for-email)
    * [Response](#response)
  * [Bulk API for multiple event requests](#bulk-api-for-multiple-event-requests)
    * [How SuprSend Processes the bulk API request](#how-suprsend-processes-the-bulk-api-request)
  * [Add file attachment in bulk API (for email)](#add-file-attachment-in-bulk-api-for-email)
  * [Response](#response-1)

...
[Suggest Edits](/edit/java-create-user-profile)
...
* [Send and Track Events](/docs/java-send-event-data)
...
* * [Pre-requisites](#pre-requisites)
  ...
  * [Create a user and add communication channels](#create-a-user-and-add-communication-channels)

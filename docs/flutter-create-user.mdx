...
<Steps>
  <Step title="Create/Identify a new user You can identify a user using suprsend.identify() method" stepNumber="1">
  ...
  <Step title="Set Communication Channel preferences" stepNumber="3">
...
<AccordionGroup>
  ...
  <Accordion title="Rremove" defaultOpen={false}>

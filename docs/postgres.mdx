---
title: "Postgres"
description: "Setting up Postgres database connection for syncing subscriber lists"
---

[Suggest Edits](/edit/postgres)
...
To start syncing data from your postgres database, you need to add postgres integration on the connector page.
...
2. Click on Postgres and add your database user’s credentials. All fields in the form are mandatory.

![](/images/docs/5c68e43-image.png)
...
| Port          | The port on which your Amazon Postgres server is listening for connections.                                                                                                                                |
...
| SSL Mode      | We support both SSL and non-SSL connections.                                                                                                                                                               |

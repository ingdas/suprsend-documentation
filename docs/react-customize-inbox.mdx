...
[Suggest Edits](/edit/react-customize-inbox)
...
* * [Customizing Theme](#customizing-theme)
  ...
  * [Customizing Bell Icon](#customizing-bell-icon)

  * [Customizing Badge (Counter)](#customizing-badge-counter)

  * [Customizing Header](#customizing-header)
    * [Adding custom Header component](#adding-custom-header-component)

  * [Customizing Tabs](#customizing-tabs)
    * [Customizing Tab Badge (Counter)](#customizing-tab-badge-counter)

  * [Customizing Notification Card](#customizing-notification-card)
    ...
    * [Action Button Custom Click Handlers](#action-button-custom-click-handlers)
    * [Avatar](#avatar)
  ...
  * [Custom Notification Card Component](#custom-notification-card-component)

  * [Set Custom Click Handler](#set-custom-click-handler)

  * [Customizing Inbox Popup Position](#customizing-inbox-popup-position)

  * [Customizing Toast](#customizing-toast)

    * [Show / Hide Toast](#show--hide-toast)
    * [Change Toast Position](#change-toast-position)
    * [Change Toast Duration](#change-toast-duration)
    * [Change Toast Notifications Limit](#change-toast-notifications-limit)
    * [Custom Toast Content Component](#custom-toast-content-component)
    * [Customize Toast Style](#customize-toast-style)

  * [Customizing Empty Inbox screen](#customizing-empty-inbox-screen)

    * [Customize Existing Empty Screen Style](#customize-existing-empty-screen-style)
    * [Custom Empty Screen Component](#custom-empty-screen-component)

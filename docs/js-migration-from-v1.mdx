...
After migrating please test all library methods to see if they everything is working properly. If you face any issue in migration process please reach out to us on our [slack community](https://suprsendcommunity.slack.com/join/shared_invite/zt-1bs6rbxr8-zI6SyJQd2b~XMpM9uaT1Bw#/shared-invite/email) or drop an email to us on [\[email protected\]](/cdn-cgi/l/email-protection#45363035352a3731053630353736202b216b262a28)
...
* * [Authentication Changes](#authentication-changes)
  ...
  * [Renamed methods and arguments to camelCase](#renamed-methods-and-arguments-to-camelcase)
  * [Removed `purchase_made` method](#removed-purchase_made-method)
  * [Removed `set_super_properties`](#removed-set_super_properties)

...
It's recommended to allow recipients to unsubscribe from emails. You can use SuprSend’s [hosted preference page](/docs/preferences#hosted-preference-page) for giving granular control to your users, allowing them to manage preferences per category while also reducing unnecessary vendor API calls for opt-outs.

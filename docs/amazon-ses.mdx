...
<Steps>
  ...
  <Step title="Give SuprSend permission to Subscribe to SNS topic." stepNumber="5">
    ...
    1. Click on`Edit`. On the edit page, expand the`Access Policy`section. The policy looks something like below. You'll notice that the current policy gives`sns:Publish`permission to your SES account.

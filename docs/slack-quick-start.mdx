---
title: "Slack"
description: "This is a quick setup guide to start sending Slack notifications with SuprSend."
---
...
### 2. [Integrate Slack](/docs/slack) and add option to join Slack in your product
...
* **Template**
   ...
   in delivery node contains the content of the notification. You can add both static and dynamic content sourced from user properties or trigger payloads. We use 

  [JSONNET](https://jsonnet.org/ref/language.html)

   as Slack templating language. You can add dynamic content as 

  `data.var`

   or 

  `data["$batched_events"][0].var`

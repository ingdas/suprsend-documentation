---
title: "WebPush"
description: "This will guide you through integration steps of webpush in react application"
---

## Integration Steps

<Steps>
<Step title="Integration of SuprSendProvider">
...
<CodeGroup>
  ...
  importScripts('https://cdn.jsdelivr.net/npm/@suprsend/web-sdk@2.0.0/public/serviceworker.min.js');
  initSuprSend(YOUR_PUBLIC_API_KEY); // replace publicApiKey with your value
  ```
</CodeGroup>
</Step>

<Step title="Accessing webpush methods using useSuprSendClient hook">

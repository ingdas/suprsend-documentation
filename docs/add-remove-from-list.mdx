...
[Suggest Edits](/edit/add-remove-from-list)
...
* * [Creating list dynamically within workflow](#creating-list-dynamically-within-workflow)
  * [Lists vs. Objects for Topic Subscriptions](#lists-vs-objects-for-topic-subscriptions)

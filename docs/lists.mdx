---
title: "Lists"
description: "Create a list of subscribers to send bulk notifications or campaigns"
---

[Suggest Edits](/edit/lists)
...
This is the most flexible way of updating users in a list. This way, you can keep the list updated in real-time. You can use [API](/reference/list-overview) or update it using backend SDK

1. [Create list using python SDK](/docs/python-lists)
2. [Create list using node SDK](/docs/node-lists)
3. [Create list using Java SDK](/docs/lists-java)
4. [Create list using Go SDK](/docs/lists-go)
...
Need support for another connector? [Please Let us know](https://suprsendcommunity.slack.com/join/shared_invite/zt-1bs6rbxr8-zI6SyJQd2b~XMpM9uaT1Bw#/shared-invite/email)
...
You can automate your list update using data directly by writing SQL query on your database. This allows your data, product and growth teams to completely own product and engagement notifications without any development effort. You can also use it to sync user profiles and send personalized broadcasts to users using their profile properties. See how to setup database sync [here](/docs/list-sync-via-database).
...
* The most recommended way to send notification to list users is via [Broadcast](/docs/broadcast). You can schedule broadcast on this list from the dashboard by clicking on "**Run Broadcast**" option or trigger it programatically via API.

  We recommend sending broadcasts using promotional category so you don't end up overloading transactional and system queues. Learn more about how to choose the right notification category [here](/docs/notification-category).
...
* * [Creating Lists](#creating-lists)
    ...
    * [2. Using third party data platforms](#2-using-third-party-data-platforms)
    * [3. From UI using CSV upload](#3-from-ui-using-csv-upload)
    * [4. Automate list sync using database connector](#4-automate-list-sync-using-database-connector)

  * [Configure list events](#configure-list-events)

  * [Sending notification to list users](#sending-notification-to-list-users)

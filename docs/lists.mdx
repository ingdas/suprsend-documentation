...
<Accordion title="Programmatically using SDK / API" defaultOpen="false">
  ...
  <CardGroup cols="4">
    <Card title="Create list using python SDK" icon="python" href="/docs/python-lists">
      
    </Card>
    <Card title="Create list using node SDK" icon="js" href="/docs/node-lists">
      
    </Card>
    <Card title="Create list using Java SDK" icon="java" href="/docs/lists-java">
      
    </Card>
    <Card title="Create list using the Go SDK" icon="golang" href="/docs/lists-go">
...
<Accordion title="Using third party data platforms" defaultOpen="false">
  ...
  <Card title="Mixpanel" icon="sparkles" href="/docs/mixpanel">

...
<Accordion title="Programmatically using SDK / API">
  ...
  <CardGroup cols="4">
    <Card title="Python SDK" icon="python" href="/docs/python-lists">
      
    </Card>
    <Card title="Node SDK" icon="js" href="/docs/node-lists">
      
    </Card>
    <Card title="Java SDK" icon="java" href="/docs/lists-java">
      
    </Card>
    <Card title="Go SDK" icon="golang" href="/docs/lists-go">

...
<Steps>
  ...
  <Step title="Trigger the workflow">
    ...
    * **Data or Event Properties** - This will be used to render dynamic content in the template (added in template mock) or variables in the workflow configuration.

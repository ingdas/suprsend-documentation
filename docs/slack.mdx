...
* [Create a Slack Workspace](https://slack.com/get-started#/landing)
* Create a Slack App - Refer [section](/docs/slack#step-2-create-a-slack-app) for creating a slack app
...
4. [Update slack channel information in user or channel profile](/docs/slack#step-4-update-slack-channel-in-user-profile) to send message
5. [Create a Slack template](/docs/slack-template) and trigger workflow
...
**Step 1.** [Sign in](https://slack.com/signin#/signin) to Slack. Navigate to [Apps page](https://api.slack.com/apps) and click on "Create New App" button
...
1. Give scoped access using [OAuth V2 method](/docs/slack#1-oauth-v2-method)
2. Give access to a particular channel / user using [incoming webhook](/docs/slack#2-incoming-webhook)
...
2. This will redirect the user to an [authorization link](https://api.slack.com/legacy/oauth#send_users) `https://slack.com/oauth/authorize`. Refer [OAuth V2](https://api.slack.com/legacy/oauth#send_users) documentation to add slack authorization flow in your product.
...
* * [Prerequisites](#prerequisites)
  ...
  * [Step 1. Enable Slack Channel](#step-1-enable-slack-channel)

  * [Step 2. Create a Slack App](#step-2-create-a-slack-app)

  * [Step 3. Assigning OAuth Scopes to App](#step-3-assigning-oauth-scopes-to-app)

    * [1. OAuth V2 method](#1-oauth-v2-method)
    * [2. Incoming webhook](#2-incoming-webhook)

  * [Step 4. Update slack channel in user profile](#step-4-update-slack-channel-in-user-profile)
  ...
  * [Step 5. Create a Slack Template](#step-5-create-a-slack-template)

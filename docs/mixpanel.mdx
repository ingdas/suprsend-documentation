...
<Steps>
  ...
  <Step title="Step-2">
    Click on Mixpanel. This will open integrations page.Click on MixpanelIt will open integrations page. Just add mapping key and click on enable. Mapping key is the unique identifier of user on SuprSend.
  </Step>

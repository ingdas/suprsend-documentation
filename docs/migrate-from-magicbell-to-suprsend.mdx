...
MagicBell's Project maps to SuprSend's Workspace. By default, when you sign up on SuprSend, you will have Staging & Production workspace setup, which can be linked to your respective projects in Magicbell. If you need more workspaces, like `Pre-Production`, reach out to our support team at [\[email protected\]](mailto:support@suprsend.com).

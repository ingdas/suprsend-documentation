...
**A.** You can build slack template in [Slack block kit builder](https://app.slack.com/block-kit-builder/T021L49RVHR) and add the content of block key in the JSONNET editor
...
* * [Design Template](#design-template)
    ...
    * [Step 1. Design Template using JSONNET editor](#step-1-design-template-using-jsonnet-editor)
    * [Step2. Preview Message](#step2-preview-message)
    * [Step3. Publish the template](#step3-publish-the-template)

  * [Adding dynamic content in Slack template](#adding-dynamic-content-in-slack-template)

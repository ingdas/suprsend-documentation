...
<CardGroup cols="3">
  <Card title="Python Backend SDK" icon="python" href="/docs/python-trigger-workflow-from-api">
    
  </Card>
  <Card title="Node Backend SDK" icon="js" href="/docs/node-trigger-workflow-from-api">
    
  </Card>
  <Card title="Java Backend SDK" icon="java" href="/docs/java-trigger-workflow-from-api">
    
  </Card>
  <Card title="Trigger Workflow HTTP API" icon="arrows-spin" href="/reference/trigger-workflow-api">
    
  </Card>
  <Card title="Backend SDK with Golang" icon="golang" href="/docs/go-trigger-workflow-from-api">
...
| `tenant_id`                        | string                             | unique identifier of the [brand / tenant](/docs/brands)                                                                                                                                                                                                                                                                                                                              |
...
<CardGroup cols="4">
  ...
  <Card title="Trigger Event HTTP API" icon="arrows-spin" href="/reference/event-api">
    
  </Card>
  <Card title="JavaScript Frontend SDK" icon="js" href="/docs/javascript-send-event-data">
    (Web)
  </Card>
  <Card title="Kotlin Frontend SDK" icon="android" href="/docs/android-send-event-data">
    (Android)
  </Card>
  <Card title="React Native Frontend SDK" icon="sparkles" href="/docs/react-native-send-event-data">
    (App)
  </Card>
...
<Steps>
  ...
  <Step title="Create a google sheet with following data.">
    ...
    - `ditinct_id`**column ** - this is the unique identifier of the user who needs to be notified.
  ...
  <Step title="Go top the Google Sheets Navbar">
    ...
    ![](/images/docs/2aa0141-Screenshot_2022-02-01_at_10.51.37_AM.png)
  </Step>
  ...
  <Step title="Save the Script - Close the Tab - Reload your Google Sheets Page!">
    ...
    ![](/images/docs/17410e4-Screenshot_2022-02-01_at_11.12.09_AM.png)
  </Step>

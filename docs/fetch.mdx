---
title: "Fetch"
description: "Learn about Fetch node functionality within SuprSend workflows"
---

[Suggest Edits](/edit/fetch)
...
Any data returned in the api request response is appended to the response\_key in your fetch function and then merged with the input payload.
...
| Recipient      | properties of recipient in your workflow trigger. In case of event, distinct\_id works both as actor and recipient, unless override recipient is set in workflow trigger settings. In case of override recipient, properties of overriden recipient is picked. | `data["$recipient"].key` |
| Brand / Tenant | properties of the tenant passed in workflow trigger.                                                                                                                                                                                                           | `data["$brand"].key`     |
...
* * [Configuring fetch node](#configuring-fetch-node)

    * [Adding variables in Fetch node](#adding-variables-in-fetch-node)
    * [Request execution](#request-execution)
    * [Merging Response to workflow input](#merging-response-to-workflow-input)

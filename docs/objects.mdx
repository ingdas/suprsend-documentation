...
<Steps>
  <Step title="Creating objects in a separate API call before trigger:">
    1. This is an ideal approach for updating objects especially if you are using object to send notification to its subscribers.
  ...
  <Step title="Adding objects inline in workflow trigger:">

  ...
  <Step title="Generating OAuth Client Key and Secret" stepNumber="1">
    1. Go to the 
       ...
       [Credentials](https://console.cloud.google.com/apis/credentials)
        ...
        page in the Google Cloud Platform console and click on 

       **"+Create Credentials"**

       . Select OAuth client ID from the options list.
    ...
    1. Since SuprSend will be used for your internal employees only, Use 
    ...
    1. After creating consent screen, Once on the 

       **Create OAuth client ID**

        screen choose Web application from the Application type dropdown. Give your application a name. We recommend something like SuprSend to make it easy to identify and locate in the future.
  ...
  <Step title="Granting permissions" stepNumber="2">
    ...
    <Steps>
      ...
      <Step title="Creating a service account and attaching a role to it" stepNumber="2">
        1. Go to 
           ...
           [Service Accounts](https://console.cloud.google.com/iam-admin/serviceaccounts)
            ...
            and select the project which has the dataset or the table that you want to use and Click on CREATE SERVICE ACCOUNT
        ...
        ![](/images/docs/14c0317-Screenshot_2022-11-29_at_11.13.18_AM.png)4. Click on `Done` to move to the list of service accounts.
      </Step>
      ...
      <Step title="Creating and downloading the JSON key" stepNumber="3">
        ...
        1. A JSON file will be downloaded on your system. This file is required in your database integration form.
      </Step>
    </Steps>
  </Step>
</Steps>
...
1. **Sync your read-only replica instance**
...
2. **User connected here should have minimal privileges**
...
3. **Sync only the data that you’ll need**
...
4. **Use {{last_sync_time}} to limit query results**
...
5. **Limit your sync frequency**
   ...
   : Setup a sync frequency based on how frequently you want to send notifications on that list. If the previous sync is still in progress when the next interval occurs, we’ll skip the operation and catch up your data on the next interval. Skipped syncs show 

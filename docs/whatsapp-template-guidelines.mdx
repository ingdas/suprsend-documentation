...
* Make your message template name clear. Instead of using a name like "template\_014" use "bus\_ticket\_details"
...
* **Cold call messages** For example: “*Is now a good time to talk?*”, “T*hank you for your interest, can we speak now?”, “I tried contacting you but you weren't available. When are you free?*”, etc.
...
* * [Template Guidelines](#template-guidelines)
  * [Template Rejections](#template-rejections)
  * [Incorrect Formatting](#incorrect-formatting)
  * [Template containing potentially abusive or threatening content](#template-containing-potentially-abusive-or-threatening-content)

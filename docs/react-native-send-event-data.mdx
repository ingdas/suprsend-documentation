...
[Suggest Edits](/edit/react-native-send-event-data)
...
3. [Create User Profile](/docs/react-native-create-user)
4. [Create Template on SuprSend platform](/docs/templates) - if you want to trigger workflow by passing the event
5. [Create Workflow on SuprSend Platform](/docs/workflows) - if you want to trigger workflow by passing the event

## Create Workflow on SuprSend Platform

For Event based workflow trigger, you'll have to [create the workflow on SuprSend Platform](/docs/design-workflow).
...
<CodeGroup>
  ...
  //method
  suprsend.track(event_name);
  suprsend.track(event_name, properties);

  //Sample values 
  suprsend.track("grocery_purchased");
...
<CodeGroup>
  ```javascript javascript
  suprsend.purchaseMade(property_obj);

  suprsend.purchaseMade({product_id:12,product_name:"Car", amount:12000})
  ```
</CodeGroup>
...
* * [Pre-requisites](#pre-requisites)
  ...
  * [Create Workflow on SuprSend Platform](#create-workflow-on-suprsend-platform)

  * [Sending Events to SuprSend](#sending-events-to-suprsend)
    * [System Events tracked by SuprSend](#system-events-tracked-by-suprsend)

  * [Advanced Concepts](#advanced-concepts)

    * [1. Super Properties](#1-super-properties)
    * [2. Special Events](#2-special-events)
    * [3. Flush Events](#3-flush-events)

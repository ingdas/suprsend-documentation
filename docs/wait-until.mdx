...
3. **Value** - Value can be [**fixed**](/docs/wait-until#fixed-values) or [**dynamic**](/docs/wait-until#dynamic-values) (evaluated dynamically from workflow data).
...
* * [How wait until works?](#how-wait-until-works)

  * [Conditions](#conditions)

    * [Type: Event is Performed](#type-event-is-performed)
    * [Adding filter on event properties](#adding-filter-on-event-properties)
    * [Adding conditions on multiple events](#adding-conditions-on-multiple-events)

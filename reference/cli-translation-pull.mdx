...
Pull translations from a SuprSend workspace into your local directory. This action does not delete existing translations; instead, it overwrites translations with the same identifier or creates new ones. <br/><br/>

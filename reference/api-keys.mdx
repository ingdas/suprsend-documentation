...
![Generating Api Keys Pn](/images/reference/generating-api-keys.png)

Next, give your API key a relevant name and click on '`Create and Save`'.

![Step 2 Generate Api Key Pn](/images/reference/step-2-generate-api-key.png)
...
## ![Step 3 Generating Api Key Pn](/images/reference/step-3-generating-api-key.png)
